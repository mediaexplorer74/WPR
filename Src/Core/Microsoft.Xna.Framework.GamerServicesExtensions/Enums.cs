namespace Microsoft.Xna.Framework.GamerServices
{
    ...
    public enum AvatarAnimationPreset1
    {
        Stand0,
        Stand1,
        Stand2,
    ...
    public enum AvatarBodyType1
    {
        Female,
        Male
    }

    public enum AvatarBone1
    {
        AnkleLeft = 11,
        AnkleRight = 15,
        BackLower = 1,
    ...
    public enum ControllerSensitivity1
    {
        Low = 0,
        Medium = 1,
        High = 2,
    ...
    public enum GamerPresenceMode1
    {
        None,
        SinglePlayer,
        Multiplayer,
    ...
    public enum GamerPrivilegeSetting1
    {
        Blocked,
        FriendsOnly,
        Everyone
    }
    public enum GamerZone1
    {
        Unknown,
        Recreation,
        Pro,
    ...
    public enum RacingCameraAngle1
    {
        Back,
        Front,
        Inside
    }
    public enum MessageBoxIcon1
    {
        None,
        Error,
        Warning,
    ...
    public enum NotificationPosition1
    {
        TopLeft,
        TopCenter,
        TopRight,
