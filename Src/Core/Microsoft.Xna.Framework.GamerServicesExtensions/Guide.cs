...
{
    public static class Guide1
    {
        public static bool _SimulateTrialMode = false;

        public static Func<string, string, IEnumerable<string>, int,
            MessageBoxIcon1, Task<int>> ShowMessageBoxFunc;
        public static Func<string, string, string, Task<string?>> 
            ShowInputBoxFunc;
        ...
        public static IAsyncResult BeginShowMessageBox(string title, string text,
            ...
            int focusButton, MessageBoxIcon1 icon, AsyncCallback callback, object state)
        {
            if (buttons.Count() > 2)
            {
        ...
        public static IAsyncResult BeginShowMessageBox(PlayerIndex player, string title, 
            string text, IEnumerable<string> buttons, int focusButton, MessageBoxIcon1 icon, AsyncCallback callback, object state)
        {
        ...
        public static void ShowComposeMessage(PlayerIndex player, string text, IEnumerable<Gamer1> recipients)
        {
            throw new NotImplementedException();
        }

        public static void ShowFriendRequest(PlayerIndex player, Gamer1 gamer)
        {
            throw new NotImplementedException();
        }
        ...
        public static void ShowGameInvite(PlayerIndex player, IEnumerable<Gamer1> recipients)
        {
            throw new NotImplementedException();
        }

        public static void ShowGamerCard(PlayerIndex player, Gamer1 gamer)
        {
            throw new NotImplementedException();
        }
        ...
        public static void ShowPlayerReview(PlayerIndex player, Gamer1 gamer)
        {
            throw new NotImplementedException();
        }
        ...
        public static NotificationPosition1 NotificationPosition
        {
            get
            {
                throw new NotImplementedException();
