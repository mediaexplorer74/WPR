...
{
    public abstract class Gamer1 : IDisposable
    {
        ...
        static Gamer1()
        {
            _SignedInGamers = new SignedInGamerCollection(new List<SignedInGamer1>{
                new SignedInGamer1() { PlayerIndex = PlayerIndex.One }
            });
        }
